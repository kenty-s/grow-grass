...
久々に早朝勉強
企業軸面談でおおよそ自身の方向性の整理
愛せる働き、愛せる企業を見つけていきたい。

## 🎄12/2～5(ポモ/3H)
☞学習：基本情報動画学習
基本情報の勉強は現在はすーさん中心
https://www.youtube.com/results?search_query=%E3%81%99%E3%83%BC%E3%81%95%E3%82%93
残業続きでろくにPCを触れず...

## 🎄12/6(ポモ/3H)
☞就活：職務経歴書作成、RUNTEQ忘年会
...
## 🎄12/14(ポモ/1.5H)
☞就活：Green,Wantedlyプロフィール作成等

## 🎄12/15(ポモ/H)
☞：家庭内会議につき０時間

## 🎄12/16(ポモ/5H)
☞就活：面接対策 面接トレーニング開始！(通常面接①基本的な質問パック)
話す中で一貫性がないことや思っていることもすぐに言葉に出来ていないことを実感

☞勉強:卒業制作
久々に大沼。http://localhost:3000/ が表示されずに4時間が溶けた。
...
## 🎄12/25(ポモ/5.5H)
☞勉強:基本情報勉強会(ラスト)、卒業制作 Googleログイン
...
☞講義:SHIFT AIセミナー
AIについて学ぶことにはやはり意味があると感じる。
場所を選ばない働き方にはやはり必要ではないだろうか。
独学で限界を感じれば入学も視野に。
...
## 🌄1/10(ポモ/4.0H)
☞勉強:卒業制作(パスワードリセット、ストロングパラメータ)/66期交流会
卒業後初の同期交流会　就活回りの内容を多く聞けたが、
- SPIは8割程度必要？
- AIは使用してOK。むしろどう使っていたか聞かれる。(勉強はチャット程度、開発からCodex)
- 商材魅力を感じられることが向いている？(Webアプリ系で果たして良いのか？AIエンジニア？)
...
☞勉強:卒業制作(URL調整)
CodexにUI任せるのは無謀か...
RUNTEQ生間で意見交換。Codexはチャットモードでなくエージェントモードで。
...
## 👹2/10(ポモ/3H)
☞就活：説明会(ユニゾンキャリア CA面談,就活サイト整理)

## 👹2/11(ポモ/H)
☞結婚記念日💒 飲酒につき、翌早朝に勉強はお見送り

## 👹2/12(ポモ/6.5H)
☞就活：説明会(ユニゾンキャリア CA面談)
☞学習：卒業制作
...
## 👹2/15(ポモ/7H)
☞学習：卒業制作(スパイス調整、デスクトップアプリアイコン、その他微調整)
...
## 👹2/24(ポモ/3H)
☞学習：卒業制作(ページネーション、スパイス×キブン)

## 👹2/25(ポモ/5H)
☞学習：卒業制作(スパイス×キブン)

## 👹2/26(ポモ/3H)
☞学習：卒業制作(微調整、本リリースレビュー提出)

## 👹2/27(ポモ/H)
☞お休み

## 👹2/28(ポモ/8H)
☞学習：卒業制作(本リリースレビュー提出後修正、シーン追加)
☞就活：type転職フェア(6社面談)
...
## 🎎3/2(ポモ/3H)
☞就活：2社1時面接へ
☞学習：卒業制作(ディル→ホワイトペッパー、修正時の無駄なコードの処理、未設定条件の補完)
...
初期値　let i = 0; //i=0から始める
条件　　i < 1000; //i=1000で止まる
増加　　i++ //1回ごとに+1する
...
parseInt 文字や小数を整数に変換するために用意されている関数(parse:読み取る、解析する。int:integer整数)
...
## 🌸4/4(ポモ/8H)
☞就活：エージェント面談、マーケ学習教材吟味

## 🌸4/5(ポモ/H)
☞学習：Webマーケティング学習

## 🌸4/6(ポモ/H)
☞学習：SEO対策(Google検索時 kibunmeshi→キブンメシ)
PV は「どれだけページが読まれたか」
訪問数 は「何回来訪があったか」
...
## 🌸4/29(ポモ/8H)
自身主催RUNTEQもくもく会
☞学習：アプリ微修正、LP修正要件確認、マーケティング(BREAK)
☞就活：求人応募

- もくもく会
- LPにおいては、GitHub連携、課題解決の部分、データベースも加えていくとGood
...
## ☔6/3(ポモ/9H)
☞就活：面談等
☞学習：ClaudeCodeウェビナー、RUNTEQ動画視聴
将来のビジョンは役職でなくやりたいことで絞るべき

## ☔6/4(ポモ/8H)
☞就活：面接
技術試験にてテーブル、URLなど設計重視
...
## ☔6/9(ポモ/4H)
☞就活：面接
初の現地面接 将来のビジョンでもたついた部分に課題(やはり職種は絞るべき)

## ☔6/10(ポモ/5H)
☞就活：面接等
アプリ説明でコア機能に絞りすぎて、「技術に偏りがある」との意見で見送りに。多少長くとも、履歴や傾向画面まで見せるようにしていくべきと実感

## ☔6/11(ポモ/8H)
☞就活：面接等
一定の資格を取得するまで現場に立たせないと断言系SES
それまでは営業を、とのことで辞退
...
☞就活：就活応募
☞試験：基本情報(A：585、B：500)
辛すぎて寝付けず...暗記部分でだいぶ負けた...
記憶を頼りにChatGPTで画像1枚にして順位付けしたが公開するとまずいかもなので割愛

## ☔6/30(ポモ/0H)
妻お仕事につきワンオペ
本日で大阪府を退職(有休消化中だったのに、何人かLINEもくれて感謝)
本当にいい職場だった

## 🏄7/1(ポモ/7H)
☞学習：基本情報(キタミ式)
☞就活：就活応募、面談
キタミ式直前ももっとちゃんとやっとけばよかったと実感

## 🏄7/2(ポモ/8H)
☞就活：面接、面談
RUNTEQCAとキャリアを再確認
受けていない方向性にも向くべき時か、、、
面接は前回までの聞いていたことと方向が違い納得せず

## 🏄7/3(ポモ/7H)
☞就活：就活応募、RUNTEQ AGENTスタート、WebCAB
☞学習：基本情報(キタミ式)